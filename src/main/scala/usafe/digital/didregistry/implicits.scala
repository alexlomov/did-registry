...
import usafe.digital.didregistry.types.Authentication.{Embedded, Referenced}
import usafe.digital.didregistry.types.PublicKeyEncoding._
import usafe.digital.didregistry.types.PublicKeyType._
